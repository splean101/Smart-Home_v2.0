class MicrowaveOven {
  ...
  increasePower() { // increasing power
    if (!this._state) {
  ...
  decreasePower () { // decreasing power
  ...
  openDoor(){ //opening door
    //........
  }
  closeDoor(){ // closing door
    //........
  }
  urnOnTimer(){ // turning timer on
    //.............
  }
  stopTimer(){ // turn timer off
    //...........
  }
}
